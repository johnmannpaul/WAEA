...
###write the results to oracle
source("process-with-corrections.R")
testing <- odbcConnect(dsn="prod.edu.state.wy.us", uid='ACCOUNTABILITY', pwd='yTv39sA0')
setSqlTypeInfo("Oracle", list(double="numeric(5,2)", integer='decimal', character='varchar(255)', logical="varchar(5)"))
getSqlTypeInfo("Oracle")
...
Rdata.to.Oracle <- function (conn, Rdata.filename, use.verbose=FALSE, exclude.cols=NULL,  other.var.types=NULL, table.prefix = "ACCOUNTABILITY.R13_") {
...
#Rdata -> Oracle
testing <- odbcConnect(dsn="prod.edu.state.wy.us", uid='ACCOUNTABILITY', pwd='yTv39sA0')
Rdata.to.Oracle(testing, "data/schools.orig.Rdata", TRUE, c("EFFECTIVE_DATE", "EXPIRATION_DATE"))
Rdata.to.Oracle(testing, "data/schools-other-attributes.Rdata", TRUE)
Rdata.to.Oracle(testing, "data/school-enrollment.Rdata", TRUE, NULL, c(ENROLLMENT='integer'))
Rdata.to.Oracle(testing, "data/paws.Rdata")
#resume here
Rdata.to.Oracle(testing, "data/Science_Scores_2013.Rdata")
Rdata.to.Oracle(testing, "data/ACT/act.Rdata")
Rdata.to.Oracle(testing, "data/paws_11_achievement.Rdata")
Rdata.to.Oracle(testing, "data/ACT/explore.Rdata")
Rdata.to.Oracle(testing, "data/ACT/plan.Rdata")
Rdata.to.Oracle(testing, "data/grads_nongrads_corrected.Rdata")
Rdata.to.Oracle(testing, "data/paws_11.Rdata")
