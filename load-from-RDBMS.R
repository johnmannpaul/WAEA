...
##RDBMS -> Rdata
RDBMS.to.Rdata <- function(conn, data.dir="data", Rdata.filename="schools.orig.Rdata", RDBMS.object.name=paste(account.schema,"R13_SCHOOLS",sep="."), R.object.name="schools", use.verbose=FALSE) {
